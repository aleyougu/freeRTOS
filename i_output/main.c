...
static StackType_t Idle_Task_Stack[((unsigned short)128)];
static StackType_t Timer_Task_Stack[(((unsigned short)128)*2)];
								   ...
								   uint32_t *pulIdleTaskStackSize)
{
	...
	*pulIdleTaskStackSize=((unsigned short)128);
}
									...
									uint32_t *pulTimerTaskStackSize)
{
	...
	*pulTimerTaskStackSize=(((unsigned short)128)*2); 
}
int main()
{
	SysTick_Init(72);
...
void task1_task(void *pvParameters)
{
    while(1)
    {
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(5<<2))))=0;
        vTaskDelay(200);
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(5<<2))))=1;
        vTaskDelay(800);
    }
}
void task2_task(void *pvParameters)
{
    while(1)
    {
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1800)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1800)+12) &0xFFFFF)<<5)+(5<<2))))=0;
        vTaskDelay(800);
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1800)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1800)+12) &0xFFFFF)<<5)+(5<<2))))=1;
        vTaskDelay(200);
    }
}
