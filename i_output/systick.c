...
void SysTick_Init(u8 SYSCLK)
{
	...
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD=reload; 						
...
{		
	...
	u32 reload=((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD;				
	ticks=nus*fac_us; 						
	told=((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL;        				
	while(1)
	{
		tnow=((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL;	
		if(tnow!=told)
		{	    
